...
global using SchoolApp.Identity.API;
global using SchoolApp.Identity.API.Configuration;
global using SchoolApp.Identity.API.Data;
global using SchoolApp.Identity.API.Models;
global using SchoolApp.Identity.API.Services;
